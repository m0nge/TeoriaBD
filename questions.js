...
const questionsBank = [
    ...
    },
    {
        id: 9,
        type: 'fill',
        question: 'SELECT también se conoce como ____ (siglas en inglés), que significa Lenguaje de Consulta de Datos.',
        correctAnswers: ['DQL', 'dql'],
        explanation: 'SELECT se conoce como DQL (Data Query Language / Lenguaje de Consulta de Datos). Aunque técnicamente forma parte de DML, tiene su propia categoría porque su función es consultar datos, no modificarlos.'
    },
    {
        id: 10,
        type: 'multiple',
    ...
    },
    {
        id: 15,
        type: 'fill',
        question: 'Para insertar múltiples registros en una sola instrucción INSERT, se utiliza la sintaxis: INSERT INTO tabla (columnas) VALUES (valores1), (____, ____), ...',
        correctAnswers: ['valores2, valores3', 'valores2,valores3', '(valores2), (valores3)'],
        explanation: 'Para insertar múltiples registros, se usa la sintaxis de inserción masiva (batch): VALUES (a, b), (c, d), (e, f); separando cada conjunto de valores con comas.'
    },
    {
        id: 16,
        type: 'multiple',
    ...
    },
    {
        id: 21,
        type: 'fill',
        question: 'Para evitar un error al intentar eliminar un objeto que no existe, se puede usar DROP con la cláusula ____ ____.',
        correctAnswers: ['IF EXISTS', 'if exists'],
        explanation: 'Se usa IF EXISTS como cláusula opcional para evitar un error si el objeto no existe. Ejemplo: DROP TABLE IF EXISTS nombre_tabla;'
    },
